...
class CrossChainMessenger {
    ...
    async toBedrockCrossChainMessage(message) {
        ...
        const minGasLimit = (0, core_utils_1.fromHexString)(resolved.message).length * 16 + 200000;
        return Object.assign(Object.assign({}, resolved), { value, minGasLimit: ethers_1.BigNumber.from(minGasLimit), messageNonce: (0, core_utils_1.encodeVersionedNonce)(ethers_1.BigNumber.from(1), resolved.messageNonce) });
    }
    ...
    async getBedrockMessageProof(message) {
        ...
        const withdrawal = await this.toLowLevelMessage(resolved);
        const messageSlot = ethers_1.ethers.utils.keccak256(ethers_1.ethers.utils.defaultAbiCoder.encode(['bytes32', 'uint256'], [(0, utils_1.hashLowLevelMessage)(withdrawal), ethers_1.ethers.constants.HashZero]));
    ...
    async proveMessage(message, opts) {
        return ((opts === null || opts === void 0 ? void 0 : opts.signer) || this.l1Signer).sendTransaction(await this.populateTransaction.proveMessage(message, opts));
    }
