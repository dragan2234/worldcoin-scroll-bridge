...
export declare class NftNamespace {
     ...
     */
    computeRarity(contractAddress: string, tokenId: BigNumberish, refreshCache?: boolean): Promise<NftAttributeRarity[]>;
    /**
     ...
     * @param refreshCache - If true, bypass cache and recompute rarity snapshot.
     */
    summarizeNftAttributes(contractAddress: string, refreshCache?: boolean): Promise<NftAttributesResponse>;
    /**
