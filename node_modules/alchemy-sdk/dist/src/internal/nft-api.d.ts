...
export declare function computeRarity(config: AlchemyConfig, contractAddress: string, tokenId: BigNumberish, refreshCache?: boolean, srcMethod?: string): Promise<NftAttributeRarity[]>;
export declare function searchContractMetadata(config: AlchemyConfig, query: string, srcMethod?: string): Promise<NftContract[]>;
export declare function summarizeNftAttributes(config: AlchemyConfig, contractAddress: string, refreshCache?: boolean, srcMethod?: string): Promise<NftAttributesResponse>;
